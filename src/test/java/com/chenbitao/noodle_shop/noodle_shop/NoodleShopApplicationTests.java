...
class NoodleShopApplicationTests {
	...
	public void testCalculateOrder() {
		...
		Money total = orderService.calculateWithDiscount(order,
	...
	public void testCalculateOrder1() {
		...
		assertEquals(0, total.getAmount().compareTo(BigDecimal.valueOf(42.00)));
	}
	...
	public void testCalculateOrder2() {
		...
		assertEquals(0, total.getAmount().compareTo(BigDecimal.valueOf(73)));
	}
	...
	public void testNoDiscountApplied() {
		...
		// 总价应为26，不打折
		assertEquals(0, total.getAmount().compareTo(BigDecimal.valueOf(26.00)));
	}
	...
	public void testDiscountExactlyAtThreshold() {
		...
		assertEquals(0, total.getAmount().compareTo(BigDecimal.valueOf(40.00))); // 44-4
	}
	...
	public void testMultipleItemsExcluded() {
		...
		assertEquals(0, total.getAmount().compareTo(BigDecimal.valueOf(60.00)));
	}
	...
	public void testLargeQuantityDiscount() {
		...
		assertEquals(0, total.getAmount().compareTo(BigDecimal.valueOf(114)));
	}
	...
	public void testAllExcludedItems() {
		...
		assertEquals(0, total.getAmount().compareTo(BigDecimal.valueOf(54.00)));
	}
}
